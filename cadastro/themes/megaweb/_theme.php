...
<head>
    <meta charset="UTF-8">
        <meta name="mit" content="2024-10-01T15:57:42-03:00+42711">
...
<header class="main_header gradient gradient-green">
    <div class="container">
        <div class="main_header_logo">
            <h1><a class="icon-star transition" title="Home" href="<?= url(); ?>">Mega<b>Zorde</b></a></h1>
        </div>
    ...
    <div class="container content">
        <section class="main_footer_content">
            <article class="main_footer_content_item">
                <h2>Sobre:</h2>
                <p>O MegaZorde é um gerenciador de contas simples, poderoso e gratuito. O prazer de tomar um café e
                    ter nenhum controle de suas contas.</p>
            ...
            <article class="main_footer_content_item">
                ...
                <p class="icon-envelope"><b>Email:</b><br> MegaZorde@gmail.com</p>
                <p class="icon-map-marker"><b>Endereço:</b><br> Muriaé, MG/Brasil</p>
            </article>
        </section>
    </div>
</footer>
